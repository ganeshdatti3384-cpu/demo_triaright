// components/exams/FinalExamComponent.tsx
...
import { Clock, AlertTriangle, ArrowLeft, FileText, Award } from 'lucide-react';
  ...
  const fetchExam = async () => {
    try {
      ...
      if (data.success) {
        ...
        toast({
          title: 'Not Eligible',
          description: data.message || 'You are not eligible for the final exam',
          variant: 'destructive'
        });
        navigate(-1);
      }
        ...
        <Card className="mb-6 border-orange-200">
          <CardHeader>
            ...
            <CardDescription>
              ...
              Remaining Attempts: {exam.remainingAttempts - 1}
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            {/* Warning for final attempt */}
            {exam.remainingAttempts === 1 && (
              <div className="flex items-center mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                <AlertTriangle className="h-5 w-5 text-orange-600 mr-2" />
                <p className="text-sm text-orange-800">
                  This is your final attempt. Make sure you're prepared!
                </p>
              </div>
            )}
          </CardContent>

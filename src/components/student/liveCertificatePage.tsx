// components/student/LiveCertificatePage.tsx
...
const liveCertificatePage = () => {
  ...
  const fetchCertificateData = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://triaright.com/api/livecourses/${enrollmentId}`, {
        headers: {
      ...
      if (data.success) {
        // Map API response to CertificateData format
        const apiData = data.data;
        const mappedData: CertificateData = {
          studentName: apiData.userDetails.fullName,
          studentEmail: apiData.userDetails.email,
          college: '', // Not provided in API
          courseTitle: apiData.courseDetails.courseName,
          stream: apiData.courseDetails.category || '',
          providerName: 'Triaright Solutions Pvt. Ltd.',
          instructorName: apiData.courseDetails.trainerName,
          internshipTitle: apiData.courseDetails.courseName,
          companyName: 'Triaright Solutions Pvt. Ltd.',
          ...
          enrollmentType: apiData.courseDetails.location.type || 'online',
          completionPercentage: '100',
          certificateId: apiData.enrollmentId
        };
        
        setCertificateData(mappedData);
        console.log('✅ Certificate data loaded:', mappedData);
      } else {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      preloadImage.src = '/lovable-uploads/livecertificate-bg.jpg';
      ...
      const canvas = await html2canvas(certificateRef.current, {
        ...
        onclone: (clonedDoc) => {
          ...
          if (clonedElement) {
            clonedElement.style.backgroundImage = 'url(/lovable-uploads/livecertificate-bg.jpg)';
        ...
        <head>
          ...
          <style>
            ...
            .certificate-container { 
              ...
              margin: 0 auto;
              background-image: url('/lovable-uploads/livecertificate-bg.jpg') !important;
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: `${certificateData.courseTitle} - Course Completion Certificate`,
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-600">Conducted By</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {new Date(certificateData.enrollmentDate).toLocaleDateString('en-US', { day: 'numeric', month: 'short', year: 'numeric' })} - {new Date(certificateData.completionDate).toLocaleDateString('en-US', { day: 'numeric', month: 'short', year: 'numeric' })}
                  </p>
                </div>
              </div>
          ...
          <CardContent className="flex justify-center p-4">
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 bg-white shadow-lg">
              <div ref={certificateRef} className="scale-90 origin-top">
                <LiveCertificateGenerator certificateData={certificateData} />
              </div>
            </div>
          </CardContent>
        </Card>
...
export default liveCertificatePage;
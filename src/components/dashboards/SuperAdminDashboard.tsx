...
import AdminCreateCoupon from '../admin/AdminCreateCoupon'; // Import the coupon creation component
            ...
            <TabsContent value="pack365" className="space-y-6">
              ...
              <Tabs value={pack365Tab} onValueChange={setPack365Tab}>
                <TabsList className="grid w-full grid-cols-4">
                  ...
                  <TabsTrigger value="create-coupon">Create Course Coupon</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="create-coupon" className="space-y-6">
                  <AdminCreateCoupon />
                </TabsContent>
              </Tabs>
            </TabsContent>

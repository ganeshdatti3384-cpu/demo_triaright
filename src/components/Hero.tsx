      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            The New Era Of Learning - Your gateway to professional growth through expert training, 
            skill development, and career opportunities. Join thousands who have transformed their careers with us.
          </p>
